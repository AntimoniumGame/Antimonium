...
var/list/__atom_flag_names = list("FLAG_SIMULATED" = FLAG_SIMULATED, "FLAG_ETHEREAL" = FLAG_ETHEREAL, "FLAG_THROWN_SPIN" = FLAG_THROWN_SPIN, "FLAG_ANCHORED" = FLAG_ANCHORED, "FLAG_TEMPERATURE_SENSITIVE" = FLAG_TEMPERATURE_SENSITIVE, "FLAG_FLAT_SURFACE" = FLAG_FLAT_SURFACE, "FLAG_SEATING" = FLAG_SEATING)
