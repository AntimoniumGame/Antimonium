...
/mob/human/proc/create_limbs()
	...
	limbs[BP_CHEST] =      new /obj/item/limb/root(src,  "upper body", 'icons/objects/items/limbs/chest.dmi',      BP_CHEST)
	limbs[BP_GROIN] =      new /obj/item/limb(src,       "lower body", 'icons/objects/items/limbs/groin.dmi',       BP_GROIN,      BP_CHEST)
	...
	limbs[BP_HEAD] =       new /obj/item/limb(src,        "head",       'icons/objects/items/limbs/head.dmi',       BP_HEAD,       BP_CHEST)
